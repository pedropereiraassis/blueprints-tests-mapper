module.exports = [
  ...
  },
  {
    ...
    "parameters": {
      ...
      "request": {
        "url": {
          "$mustache": "https://api.{{{environment.BASE_URL}}}/approval/dates_options"
        },
        "verb": "GET",
        "headers": {
          "Authorization": {
  ...
  },
  {
    ...
    "parameters": {
      ...
      "request": {
        "url": {
          "$mustache": "https://api.{{{environment.BASE_URL}}}/approval/status?grace_period={{{bag.grace_period}}}"
        },
        "verb": "GET",
        "headers": {
          "Authorization": {
  ...
  },
  {
    ...
    "parameters": {
      ...
      "request": {
        "url": {
          "$mustache": "https://api.{{{environment.BASE_URL}}}/user/profile/lending_option"
        },
        "verb": "POST",
        "headers": {
          "Authorization": {
  ...
  },
  {
    ...
    "parameters": {
      ...
      "request": {
        "url": {
          "$mustache": "https://lists.{{{environment.BASE_URL}}}/api/banks?order_by=id&limit=200"
        },
        "verb": "GET"
      },
      "valid_response_codes": [
  ...
  },
  {
    ...
    "parameters": {
      ...
      "request": {
        "url": {
          "$mustache": "https://api.{{{environment.BASE_URL}}}/user/profile/bank"
        },
        "verb": "POST",
        "headers": {
          "Authorization": {
  ...
  },
  {
    ...
    "parameters": {
      ...
      "request": {
        "url": {
          "$mustache": "https://api.{{{environment.BASE_URL}}}/user/contract/proposal"
        },
        "verb": "GET",
        "headers": {
          "Authorization": {
  ...
  },
  {
    ...
    "parameters": {
      ...
      "request": {
        "url": {
          "$mustache": "{{{environment.USER_PROFILE_API_URL}}}/api/profiles/{{{bag.creatorId}}}"
        },
        "verb": "GET",
        "headers": {
          "Authorization": {
  ...
  },
  {
    ...
    "parameters": {
      ...
      "request": {
        "url": {
          "$mustache": "{{{environment.USERS_API_URL}}}/api/users/{{{bag.creatorId}}}"
        },
        "verb": "GET",
        "headers": {
          "Authorization": {
            "$mustache": "LendicoLogin apikey=\"{{{environment.USERS_API_KEY}}}\""
          }
        }
      },
      "valid_response_codes": [
  ...
  },
  {
    ...
    "parameters": {
      ...
      "request": {
        "url": {
          "$mustache": "https://inbound-api.{{{environment.BASE_URL}}}/api/partners?name={{{bag.approval.input_data.sub_origin}}}"
        },
        "verb": "GET",
        "headers": {
          "Authorization": {
            "$mustache": "LendicoLogin apikey={{{environment.INBOUND_API_KEY}}}"
          }
        }
      },
      "valid_response_codes": [
    ...
    "parameters": {
      "input": {
        "ContractRequestBody": {
          ...
          "product_type": {
            "$js": "({bag}) => bag.approval.policy.product.code != 'EP' ? bag.approval.policy.product.code : 'CP'"
          },
          "lending_value": {
          ...
          "partner_integration_strategy": {
            "$js": "({bag}) => bag.approval.policy.partner.name === 'SOROCRED' ? 'lcm.partners.sorocred.webservice_strategy.SOROCREDWebServiceStrategy' : 'lcm.partners.lendicoscd.webservice_strategy.LENDICOSCDWebServiceStrategy'"
          }
        }
      }
    }
  },
  {
    ...
    "parameters": {
      ...
      "request": {
        "url": {
          "$mustache": "{{{environment.CONTRACT_MANAGER_API_URL}}}/api/contracts"
        },
        "verb": "POST",
        "headers": {
          "Authorization": {
            "$mustache": "LendicoLogin apikey=\"{{{environment.CONTRACT_MANAGER_API_KEY}}}\""
          }
        }
      }
    }
